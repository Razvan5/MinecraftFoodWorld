package com.electrosugar.foodworld.recipeplacer;
...
public class ServerRecipePlacerPot<C extends IInventory> extends ServerRecipePlacer<C> {
    private boolean matches;

    public ServerRecipePlacerPot(RecipeBookContainer<C> p_i50751_1_) {
        super(p_i50751_1_);
    }
