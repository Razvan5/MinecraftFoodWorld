...
public abstract class AbstractPotBlockTest extends ContainerBlock {
    public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
    public static final BooleanProperty LIT = RedstoneTorchBlock.LIT;

    protected AbstractPotBlockTest(Block.Properties properties) {
        super(properties);
    ...
    /**
     * Interface for handling interaction with blocks that impliment AbstractPotBlockTest. Called in onBlockActivated
     * inside AbstractPotBlockTest.
     */
