...
public abstract class AbstractPotTileEntityTest extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.burnTime;
                case 1:
                    return com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.recipesUsed;
                case 2:
                    return com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.cookTime;
                case 3:
                    return com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.burnTime = value;
                    break;
                case 1:
                    com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.recipesUsed = value;
                    break;
                case 2:
                    com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.cookTime = value;
                    break;
                case 3:
                    com.electrosugar.foodworld.test.AbstractPotTileEntityTest.this.cookTimeTotal = value;
            }
    ...
    protected final IRecipeType<? extends AbstractBoilingRecipeTest> recipeType;

    protected AbstractPotTileEntityTest(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractBoilingRecipeTest> recipeTypeIn) {
        super(tileTypeIn);
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.items.get(0).isEmpty()) {
                IRecipe<?> irecipe = this.world.getRecipeManager().getRecipe((IRecipeType<AbstractBoilingRecipeTest>)this.recipeType, this, this.world).orElse(null);
    ...
    protected int getCookTime() {
        return this.world.getRecipeManager().getRecipe((IRecipeType<AbstractBoilingRecipeTest>)this.recipeType, this, this.world).map(AbstractBoilingRecipeTest::getCookTime).orElse(200);
    }
    ...
    public void func_213995_d(PlayerEntity player) {
        ...
        for(Entry<ResourceLocation, Integer> entry : this.field_214022_n.entrySet()) {
            player.world.getRecipeManager().getRecipe(entry.getKey()).ifPresent((p_213993_3_) -> {
                ...
                spawnExpOrbs(player, entry.getValue(), ((AbstractBoilingRecipeTest)p_213993_3_).getExperience());
            });
        }
