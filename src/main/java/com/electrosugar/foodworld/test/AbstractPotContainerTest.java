...
public abstract class AbstractPotContainerTest extends RecipeBookContainer<IInventory> {
    private final IInventory furnaceInventory;
    private final IIntArray furnaceData;
    protected final World world;
    private final IRecipeType<? extends AbstractBoilingRecipeTest> recipeType;

    protected AbstractPotContainerTest(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractBoilingRecipeTest> recipeTypeIn, int id, PlayerInventory playerInventoryIn) {
        this(containerTypeIn, recipeTypeIn, id, playerInventoryIn, new Inventory(3), new IntArray(4));
    }

    protected AbstractPotContainerTest(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractBoilingRecipeTest> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray furnaceDataIn) {
        ...
        this.addSlot(new PotFluidSlotTest(this, furnaceInventoryIn, 1, 56, 53));
        this.addSlot(new PotResultSlotTest(playerInventoryIn.player, furnaceInventoryIn, 2, 116, 35));
