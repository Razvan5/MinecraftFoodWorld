...
public class PotResultSlotTest extends Slot {
    private final PlayerEntity player;
    private int removeCount;

    public PotResultSlotTest(PlayerEntity player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
